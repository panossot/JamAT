...
public class MetricsThreads14 extends Thread {

    private Thread t;
    private String threadName;
    MetricsApiSeTestClass14 metricsApiSeTestClass;

   public  MetricsThreads14(String name, MetricsApiSeTestClass14 metricsApiSeTestClass) {
        threadName = name;
