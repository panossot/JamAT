...
public class MetricsThreads11 extends Thread {

    private Thread t;
    private String threadName;
    MetricsApiSeTestClass11 metricsApiSeTestClass;

   public  MetricsThreads11(String name, MetricsApiSeTestClass11 metricsApiSeTestClass) {
        threadName = name;
