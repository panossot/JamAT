...
public class MetricsThreads16 extends Thread {

    private Thread t;
    private String threadName;
    MetricsApiSeTestClass16 metricsApiSeTestClass;

   public  MetricsThreads16(String name, MetricsApiSeTestClass16 metricsApiSeTestClass) {
        threadName = name;
