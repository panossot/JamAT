...
public class MetricsThreads3 extends Thread {

    private Thread t;
    private String threadName;
    MetricsApiSeTestClass3 metricsApiSeTestClass;
    
    private String deploymentName = "myTestDeployment";
    private String deploymentName2 = "myTestDeployment2";

   public  MetricsThreads3(String name, MetricsApiSeTestClass3 metricsApiSeTestClass) {
        threadName = name;
