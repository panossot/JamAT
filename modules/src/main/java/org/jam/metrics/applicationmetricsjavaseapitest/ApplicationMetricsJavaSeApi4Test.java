...
public class ApplicationMetricsJavaSeApi4Test {
    ...
    public void test() {
        try {
            ...
            MetricsApiSeTestClass4 mTC = new MetricsApiSeTestClass4();
            MetricsThreads4 mTreads =  new MetricsThreads4("1",mTC);
            mTreads.start();
         
            MetricsThreads4 mTreads2 =  new MetricsThreads4("2",mTC);
            mTreads2.start();
            
            MetricsThreads4 mTreads3 =  new MetricsThreads4("3",mTC);
            mTreads3.start();
