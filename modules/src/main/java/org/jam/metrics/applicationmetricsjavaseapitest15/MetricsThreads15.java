...
public class MetricsThreads15 extends Thread {

    private Thread t;
    private String threadName;
    MetricsApiSeTestClass15 metricsApiSeTestClass;

   public  MetricsThreads15(String name, MetricsApiSeTestClass15 metricsApiSeTestClass) {
        threadName = name;
