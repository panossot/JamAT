...
public class MetricsApiSeTestClass4 {
    ...
    public synchronized int countMethod() throws Exception {
        ...
        ApplicationJavaSeMetricsDbStore.metricsDbStore(this, new Object[]{count}, "myTestGroup", "statement_1", new String[]{"StoreDBMetric","count"}, metricUser);
        ApplicationJavaSeMetrics.metric(this,count2,"count2","myTestGroup");
        CodeParamsCollection.getCodeParamsCollection().getCodeParamsInstance(metricUser).putIntegerCodeParam("sequenceNum", i++);
        ApplicationJavaSeMetricsDbStore.metricsDbStore(this, new Object[]{count2}, "myTestGroup", "statement_1", new String[]{"StoreDBMetric","count2"}, metricUser);
