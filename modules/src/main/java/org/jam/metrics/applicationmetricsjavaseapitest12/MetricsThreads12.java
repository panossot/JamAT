...
public class MetricsThreads12 extends Thread {

    private Thread t;
    private String threadName;
    MetricsApiSeTestClass12 metricsApiSeTestClass;

   public  MetricsThreads12(String name, MetricsApiSeTestClass12 metricsApiSeTestClass) {
        threadName = name;
