...
public class MetricsThreads17 extends Thread {

    private Thread t;
    private String threadName;
    MetricsApiSeTestClass17 metricsApiSeTestClass;

   public  MetricsThreads17(String name, MetricsApiSeTestClass17 metricsApiSeTestClass) {
        threadName = name;
