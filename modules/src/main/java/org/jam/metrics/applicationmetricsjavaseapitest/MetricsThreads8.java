...
public class MetricsThreads8 extends Thread {

    private Thread t;
    private String threadName;
    MetricsApiSeTestClass8 metricsApiSeTestClass;
    
    private String deploymentName = "myTestDeployment";
    private String deploymentName2 = "myTestDeployment2";

   public  MetricsThreads8(String name, MetricsApiSeTestClass8 metricsApiSeTestClass) {
        threadName = name;
