...
public class ApplicationMetricsJavaSeApi9Test {
    ...
    public void test() {
        try {
            ...
            MetricsApiSeTestClass9 mTC = new MetricsApiSeTestClass9();
            MetricsThreads9 mTreads =  new MetricsThreads9("1",mTC);
            mTreads.start();
         
            MetricsThreads9 mTreads2 =  new MetricsThreads9("2",mTC);
            mTreads2.start();
            
            MetricsThreads9 mTreads3 =  new MetricsThreads9("3",mTC);
            mTreads3.start();
