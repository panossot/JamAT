...
public class MetricsThreads9 extends Thread {

    private Thread t;
    private String threadName;
    MetricsApiSeTestClass9 metricsApiSeTestClass;
    
    private String deploymentName = "myTestDeployment";
    private String deploymentName2 = "myTestDeployment2";

   public  MetricsThreads9(String name, MetricsApiSeTestClass9 metricsApiSeTestClass) {
        threadName = name;
